...
#./build_k8ss.sh "2.0.3.asb14061-1" "1.0.13.asb4142nodetoolscheduler502-1"
...
docker build --build-arg=CQLAI_VERSION=0.1.1 --build-arg=AXON_AGENT_VERSION=${AXON_AGENT_VERSION} --build-arg=AXON_AGENT_JAVA_VERSION=${AXON_AGENT_JAVA_VERSION} --build-arg CASSANDRA_VERSION=5.0.6 --build-arg MAJOR_VERSION=5.0 --build-arg K8SSANDRA_BASE_DIGEST=sha256:bc5708b8ac40c2ad027961a2b1e1b70c826468b8b727c30859718ffc24d7ae04 --build-arg K8SSANDRA_API_VERSION=0.1.111 --tag ttl.sh/marc-axonops-cassandra:${TAG} ./k8ssandra/5.0
...
yq -i ".spec.cassandra.serverImage = \"ttl.sh/marc-axonops-cassandra:${TAG}\"" ~/axonops-containers/k8ssandra/scripts/axon-cluster.yml
